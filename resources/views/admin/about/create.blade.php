      ...
      <div class="card">
        ...
        @csrf
          <div class="mb-3" style="width: 600px; ">
              ...
              <input type="text" name="title_ru" class="form-control input-default " value="{{$about->getTranslation('title', 'uz')}}">
          </div>
          <div class="card-body custom-ekeditor">
            <textarea id="ckeditor" name="body_uz" cols="30" rows="10">{{ $about->getTranslation('body', 'uz') }}</textarea>
          </div>
