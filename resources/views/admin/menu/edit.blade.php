                        ...
                        <div class="card-body">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="Viewall-tab-pane" role="tabpanel"
                                    ...
                                    <form action="{{ route('menus.update', ['menu'=>$menuId->id]) }}" method="post">
                                        @csrf
                                        @method('PUT')
                                        <div class="mb-3">
                                            <label for="exampleFormControlInput1" class="form-label"
                                                style="color:black;"><b>Menyu
                                                    nomi</b></label>
                                            <input type="text" name="name" value="{{ $menuId->name }}" class="form-control">
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <div
                                                ...
                                                <select class="default-select form-control wide" name="page_id"
                                                    ...
                                                    @foreach ($pages as $page)
                                                        <option value="{{ $page->id }}" {{ ($menuId->page_id == $page->id) ? 'selected':'' }}>{{ $page->title }}</option>
                                                    @endforeach    
                                                </select>
                                            </div>
                                        </div>
