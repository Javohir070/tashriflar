                            ...
                            <ul class=" tab-my nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link " id="Viewall-tab" data-bs-toggle="tab"
                                        ...
                                        aria-controls="Viewall-tab-pane" aria-selected="falsa"><i
                                ...
                                <li class="nav-item" role="presentation">
                                    ...
                                    <button class="nav-link active" id="Search-tab" data-bs-toggle="tab"
                                        ...
                                        aria-controls="Search-tab-pane" aria-selected="true"><i
                                            class="fas fa-plus"></i> Submenu</button>
                                </li>

                            </ul>
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade " id="Viewall-tab-pane" role="tabpanel"
                                    ...
                                    <form action="{{ route('menus.store')}}" method="post">
                                        ...
                                        <button type="submit" class="btn btn-secondary btn-sm dz-menu-btn">Saqlash</button>
                                ...
                                <div class="tab-pane fade show active" id="Search-tab-pane" role="tabpanel"
                                    ...
                                    <form action="{{ route('submenu.update', ['submenu'=>$submenuId->id]) }}" method="post">
                                        @csrf
                                        @method('PUT')
                                        <div class="mb-3">
                                            <label for="exampleFormControlInput1" class="form-label"
                                            ...
                                            <input type="text" name="name" value="{{ $submenuId->name }}" class="form-control">
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <div
                                                ...
                                                <select class="default-select form-control wide" name="menu_id"
                                                    tabindex="null">
                                                    @foreach ($menus as $menu)
                                                        <option value="{{ $menu->id }}" {{ ($submenuId->menu_id == $menu->id) ? 'selected':'' }}>{{ $menu->name }}</option>
                                                    @endforeach    
                                                </select>
                                            </div><br><br>
                                            <label class="form-label" style="color:black;"><b>Sahifa
                                            ...
                                            <div
                                                ...
                                                <select class="default-select form-control wide" name="page_id"
                                                    tabindex="null">
                                                    @foreach ($pages as $page)
                                                        <option value="{{ $page->id }}" {{ ($submenuId->page_id == $page->id) ? 'selected':'' }}>{{ $page->title }}</option>
                                                    @endforeach 
                                                </select>
                                            </div>
                                        </div>
                                        <button type="submit" class="btn btn-secondary btn-sm dz-menu-btn">Yangilash</button>
                                        <a href="{{ route('menus.index') }}" class="btn btn-primary btn-sm dz-menu-btn">Bekor qilish</a>
                                    </form>
